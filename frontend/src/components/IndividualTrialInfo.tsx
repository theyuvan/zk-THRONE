...
const trialDetails = {
  ...
  hiddenSigil: {
    ...
    color: '#FF2E63',
    howItWorks: [
      'Hidden symbols appear briefly on the screen',
      'Use visual clues to reveal concealed patterns',
      'Identify the correct symbol from options',
      'Time pressure increases difficulty',
    ],
    rules: [
      'Symbols are shown for only 2-3 seconds',
      'Background patterns hide the true symbol',
      'Must identify 5 hidden symbols correctly',
      'Each miss reduces your score',
      'Speed bonus for quick identification',
    ],
    objective: 'Sharpen your perception and attention to hidden details',
    difficulty: 'Beginner',
  },
  logicLabyrinth: {
    icon: Brain,
  ...
  patternOracle: {
    ...
    rules: [
      ...
      'Must complete 6 different pattern types',
  ...
  memoryOfCrown: {
    ...
    rules: [
      ...
      'Perfect recall required for 3 rounds',
  ...
  timekeeper: {
    ...
    color: '#00F0FF',
    howItWorks: [
      'Solve puzzles while managing time constraints',
      'Time speeds up and slows down dynamically',
    ...
    rules: [
      ...
      'Wrong answers reduce time faster',
      'Must maintain positive time to continue',
      'Complete 5 challenges before time runs out',
    ],
    objective: 'Excel under pressure and master perfect timing',
    difficulty: 'Advanced',
  },
  finalOath: {
    icon: Scroll,
    ...
    rules: [
      'Combines elements from all 6 previous trials',
